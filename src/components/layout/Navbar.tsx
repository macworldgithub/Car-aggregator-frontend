...
const Navbar = () => {
  ...
  // Check token on page load and whenever storage changes
  useEffect(() => {
    const checkToken = () => {
    ...
    // Listen for changes in localStorage (useful for multiple tabs)
  ...
  const handleLogout = () => {
    ...
    window.location.href = "/"; // refresh + home
  };
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:block">
              {isLoggedIn ? (
                ...
                <Link
                  href="/signin"
                  className="flex items-center gap-2 bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-900 transition shadow-md"
                >
                  <LogIn size={18} />
                  Sign In
                </Link>
            ...
            <div className="px-6 py-6 space-y-5">
              ...
              <div className="pt-4">
                {isLoggedIn ? (
                  <button
                    onClick={handleLogout}
                    className="block w-full text-center bg-red-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-red-700 transition"
                  >
                    Logout
                  </button>
                ) : (
